const lecturersData = [
  ...
  {
    name: "Budi Arif Dermawan, M.Kom.",
    title: "Dosen Informatika",
    imageUrl: "/assets/images/person.png",
    phone: "085716061430",
    email: "budi.arif@staff.unsika.ac.id",
    nidn: "0008019004",
  },
  {
    name: "Carudin, M.Kom.",
  ...
  {
    name: "E. Haodudin Nurkifli, S.T., M.Cs.",
    title: "Dosen Informatika",
    imageUrl: "/assets/images/person.png",
    phone: "08999171682",
  ...
  {
    name: "Oman Komarudin, S.Si., M.Kom.",
    title: "Dosen Informatika",
    imageUrl: "/assets/images/person.png",
    phone: "081212073393",
...
// Langkah 2: Ambil "wadah" (container) dari HTML
const container = document.getElementById("lecturerContainer");

lecturersData.forEach((lecturer) => {
  const card = document.createElement("div");
  card.className = `
    flex flex-col sm:flex-row items-center bg-[#2a2c41] rounded-xl p-6 shadow-lg
    hover:-translate-y-1 hover:shadow-2xl transition-all duration-300
  `;

  card.innerHTML = `
    <img src="${lecturer.imageUrl}" alt="${lecturer.name}"
      class="w-20 h-20 rounded-full object-cover mb-4 sm:mb-0 sm:mr-5">
